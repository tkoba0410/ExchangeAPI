...
- bitFlyer は `GetMarkets`, `GetBoard`, `GetTicker`, `GetExecutionsPublic`, `GetBalance`, `GetCollateral`, `GetCollateralAccounts`, `GetChildOrders`, `GetExecutionsPrivate`, `GetPositions`, `GetCollateralHistory`, `SendChildOrder`, `CancelChildOrder`, `CancelAllChildOrders`
- Binance は `GetKlines`
