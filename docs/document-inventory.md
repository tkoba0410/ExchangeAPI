...
- [`docs/release-checklist-v3.2.0.md`](./release-checklist-v3.2.0.md)
...
- [`docs/release-checklist-v3.7.0.md`](./release-checklist-v3.7.0.md)
  - v3.7.0 release gate と preflight checklist として維持する
...
- [`docs/release-notes/v3.2.0.md`](./release-notes/v3.2.0.md)
...
- [`docs/release-notes/v3.7.0.md`](./release-notes/v3.7.0.md)
  - v3.7.0 release notes として維持する
...
- [`docs/plan-v3.8.0.md`](./plan-v3.8.0.md)
  - v3.8.0 Realtime Lifecycle / Contract Hardening preparation 指示として維持する
- [`docs/plan-v3.9.0.md`](./plan-v3.9.0.md)
  - v3.9.0 Realtime Verification / Foundation Close 実施指示として維持する
