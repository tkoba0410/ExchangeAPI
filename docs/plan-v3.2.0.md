...
- public realtime live test の短時間 opt-in 実行の安定化
...
- Realtime hardening をどこまで v3.2.0 に入れるか
- reconnect / backoff を v3.2.0 で実装しない場合、どの文書へ見送り理由を残すか
- board state builder を v3.2.0 で実装しない場合、sample / guide だけ残すか
- Rx optional integration を v3.2.0 でやるか、v3.3 以降へ送るか
- v4 venue candidate comparison の粒度
- onboarding guide を `docs/guides/` に置くか、`docs/venue-onboarding.md` に置くか
