...
安定保証の正本は、公開 API 契約条文が `docs/normative/contracts/contracts.md`、
失敗時契約が `docs/normative/contracts/resilience.md`、
`docs/normative/contracts/overview.md` は概要導線とする。

## 対象読者

- 取引所機能網羅を必要とする Bot / 高度利用者
- 一般利用者向けの安定契約は、`docs/normative/contracts/contracts.md`（公開 API 契約条文）と `docs/normative/contracts/resilience.md`（失敗時契約）を正本参照する
...
- 公開安定面は Contracts 層のみ。公開 API 契約条文は `docs/normative/contracts/contracts.md`、失敗時契約は `docs/normative/contracts/resilience.md` を参照する。
