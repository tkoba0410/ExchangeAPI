...
本書は、すべてのレビューテンプレート（REVIEW-BOUNDARY / REVIEW-CHANGE / REVIEW-CONSISTENCY / REVIEW-CONTRACTS / REVIEW-DOCS / REVIEW-DX / REVIEW-REF-DELTA / REVIEW-RELIABILITY / REVIEW-SECURITY）に対する
**メタレビュー基準（品質統治基準）**である。
