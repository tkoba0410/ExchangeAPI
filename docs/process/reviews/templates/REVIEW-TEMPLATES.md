...
本書は、すべてのレビューテンプレート（REVIEW-BOUNDARY / REVIEW-CHANGE / REVIEW-CONSISTENCY / REVIEW-CONTRACTS / REVIEW-DOCS / REVIEW-DX / REVIEW-RELIABILITY / REVIEW-SECURITY / REVIEW-USER-GUIDE）に対する
**メタレビュー基準（品質統治基準）**である。
