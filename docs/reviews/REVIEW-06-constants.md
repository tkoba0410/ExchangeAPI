...
- Evidence: `src/Exchanges/Common/Application/ExchangeInfo/Adapter/Internal/ExchangeInfoMarketResolver.cs` の `"Contracts"`, `"ExchangeInfoMarketResolver"`、および `src/Exchanges/Common/Application/ExchangeInfo/Adapter/Internal/AdapterCallMapper.cs` の `Layer: "Contracts"`。
...
- Evidence: `src/Exchanges/Common/Application/ExchangeInfo/Adapter/Internal/*.cs` と `CallMeta.CreateInternal("Raw", ...)` を使う複数箇所。
