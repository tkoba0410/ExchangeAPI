...
- Evidence: docs/contracts/resilience.md
...
- Evidence: docs/contracts/overview.md
- Evidence: docs/index.md
...
### P0: 「最小導入ガイド（5分で1成功）」を docs/reviews ではなく利用者向け導線に明示
...
- Evidence: src/Primitives/DomainCommon/Types/Symbol.cs
- Evidence: src/Primitives/DomainCommon/Types/Period.cs
- Evidence: docs/contracts/contracts.md
