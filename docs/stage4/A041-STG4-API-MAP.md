...
| /v1/getmarkets / /v1/markets | GET | HTTP | Public | Stage1? | 未実装 | 取扱商品一覧 |
...
| /v1/getfundingrate | GET | HTTP | Public | 時期未定 | 未実装 | ファンディングレート |
| /v1/getcorporateleverage | GET | HTTP | Public | 時期未定 | 未実装 | 法人最大レバレッジ |
| /v1/getchats | GET | HTTP | Public | 時期未定 | 未実装 | チャット |
...
| /v1/me/getcollateralaccounts | GET | HTTP | Private GET | 時期未定 | 未実装 | 証拠金通貨別残高 |
...
| /v1/me/getbalancehistory | GET | HTTP | Private GET | 時期未定 | 未実装 | 残高履歴 |
| /v1/me/gettradingcommission | GET | HTTP | Private GET | 時期未定 | 未実装 | 手数料取得 |
