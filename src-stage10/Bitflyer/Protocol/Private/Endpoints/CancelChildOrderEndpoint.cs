    ...
    public sealed partial class BitflyerPrivateProtocolApi
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return _transport.SendAsync(
                ExchangeApi.Stage10.Bitflyer.Protocol.Private.Endpoints.CancelChildOrderWireSpec.Build(bodyJson),
                cancellationToken);
        }
    }
}
...
namespace ExchangeApi.Stage10.Bitflyer.Protocol.Private.Endpoints
{
    internal static class CancelChildOrderWireSpec
    {
        ...
        internal const string Path = ProtocolPaths.CancelChildOrder;
