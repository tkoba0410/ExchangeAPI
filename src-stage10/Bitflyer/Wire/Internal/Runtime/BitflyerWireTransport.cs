...
public sealed class BitflyerWireTransport : IWireTransport
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        catch (OperationCanceledException)
        {
            ...
            return CreateTransportErrorCall(
                ...
                startedAt,
                duration,
                new CallError(CallErrorKind.Transport, "Wire transport canceled."));
        }
        catch (Exception ex)
        {
            var duration = DateTimeOffset.UtcNow - startedAt;
            return CreateTransportErrorCall(
                ...
                startedAt,
                duration,
                new CallError(CallErrorKind.Transport, "Wire transport failed.", ex));
        }
    }
    ...
    private string ResolveTransportPath(WireCallSpec request)
    {
        ...
        {
            return WirePaths.GetTickerAlias;
        }
