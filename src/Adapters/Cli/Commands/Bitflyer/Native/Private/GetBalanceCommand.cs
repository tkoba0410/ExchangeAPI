...
public static class GetBalanceCommand
{
    public static CommandDescriptor Create()
    {
        return new CommandDescriptor
        {
            ...
            UsageExamples =
            [
                "exchangeapi bitflyer native private get-balance",
                """exchangeapi bitflyer native private get-balance --request-json '{}'""",
                "exchangeapi bitflyer native private get-balance --request-template",
            ],
            IsWrite = false,
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return JsonInputReader.Deserialize<GetBalanceRequest>(jsonInput.Content!);
        }

        return RequestBindingResult.Success(new GetBalanceRequest());
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var call = await bundle.Private.GetBalanceAsync((GetBalanceRequest)request, cancellationToken);
        return ExecutionOutcome.FromCall(new CommandPath("bitflyer", "native", "private", "get-balance"), call);
    }
}
