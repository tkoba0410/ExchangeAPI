...
public static class GetBankAccountsCommand
{
    public static CommandDescriptor Create()
    {
        return new CommandDescriptor
        {
            ...
            UsageExamples =
            [
                "exchangeapi bitflyer native private get-bank-accounts",
                """exchangeapi bitflyer native private get-bank-accounts --request-json '{}'""",
                "exchangeapi bitflyer native private get-bank-accounts --request-template",
            ],
            IsWrite = false,
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return JsonInputReader.Deserialize<GetBankAccountsRequest>(jsonInput.Content!);
        }

        return RequestBindingResult.Success(new GetBankAccountsRequest());
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var call = await bundle.Private.GetBankAccountsAsync((GetBankAccountsRequest)request, cancellationToken);
        return ExecutionOutcome.FromCall(new CommandPath("bitflyer", "native", "private", "get-bank-accounts"), call);
    }
}
