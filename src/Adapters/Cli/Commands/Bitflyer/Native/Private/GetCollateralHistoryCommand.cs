...
public static class GetCollateralHistoryCommand
{
    public static CommandDescriptor Create()
    {
        return new CommandDescriptor
        {
            Path = new CommandPath("bitflyer", "native", "private", "get-collateral-history"),
            EndpointId = "GetCollateralHistory",
            Summary = "bitFlyer native private collateral history",
            ...
            CanonicalJsonExample = """exchangeapi bitflyer native private get-collateral-history --request-json '{"count":10,"before":null,"after":null}'""",
            CommandOptions =
            [
            ...
            UsageExamples =
            [
                "exchangeapi bitflyer native private get-collateral-history --count 10",
                """exchangeapi bitflyer native private get-collateral-history --request-json '{"count":10,"before":null,"after":null}'""",
                "exchangeapi bitflyer native private get-collateral-history --request-template",
            ],
            IsWrite = false,
            BindRequestAsync = BindRequestAsync,
            DescribeRequest = static request =>
            {
                var typed = (GetCollateralHistoryRequest)request;
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return JsonInputReader.Deserialize<GetCollateralHistoryRequest>(jsonInput.Content!);
        }
        ...
        return RequestBindingResult.Success(new GetCollateralHistoryRequest
        {
            Count = count,
            Before = before,
            After = after,
