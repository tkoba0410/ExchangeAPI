...
public static class GetBoardCommand
{
    public static CommandDescriptor Create()
    {
        return new CommandDescriptor
        {
            Path = new CommandPath("bitflyer", "native", "public", "get-board"),
            EndpointId = "GetBoard",
            ...
            UsageExamples =
            [
                "exchangeapi bitflyer native public get-board --product-code BTC_JPY",
                """exchangeapi bitflyer native public get-board --request-json '{"product_code":"BTC_JPY"}'""",
                "exchangeapi bitflyer native public get-board --request-template",
            ],
            IsWrite = false,
            BindRequestAsync = BindRequestAsync,
            DescribeRequest = static request =>
            {
                var typed = (GetBoardRequest)request;
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return JsonInputReader.Deserialize<GetBoardRequest>(jsonInput.Content!);
        }

        return RequestBindingResult.Success(new GetBoardRequest
        {
