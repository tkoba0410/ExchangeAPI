...
public static class GetAddressesProtocolCommand
{
    private static readonly CommandPath Path = new("bitflyer", "protocol", "private", "get-addresses");
    ...
    public static CommandDescriptor Create()
    {
        return new CommandDescriptor
        {
            ...
            UsageExamples =
            [
                "exchangeapi bitflyer protocol private get-addresses --query-json '{}'",
                "exchangeapi bitflyer protocol private get-addresses --query-template",
            ],
            IsWrite = false,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var call = await bundle.Private.GetAddressesAsync(cancellationToken);
