...
public static class GetBalanceHistoryProtocolCommand
{
    private static readonly CommandPath Path = new("bitflyer", "protocol", "private", "get-balance-history");
    private static readonly ProtocolQuerySchema QuerySchema = new(
    [
        ProtocolQueryFieldSpec.String("currency_code"),
    ...
    public static CommandDescriptor Create()
    {
        return new CommandDescriptor
        {
            ...
            UsageExamples =
            [
                """exchangeapi bitflyer protocol private get-balance-history --query-json '{"currency_code":"JPY","count":10}'""",
                "exchangeapi bitflyer protocol private get-balance-history --query-template",
            ],
            IsWrite = false,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var call = await bundle.Private.GetBalanceHistoryCallAsync(
            typed.GetString("currency_code"),
            typed.GetInt("count"),
