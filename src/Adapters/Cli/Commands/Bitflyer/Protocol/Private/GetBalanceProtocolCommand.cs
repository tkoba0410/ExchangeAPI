...
public static class GetBalanceProtocolCommand
{
    private static readonly CommandPath Path = new("bitflyer", "protocol", "private", "get-balance");
    ...
    public static CommandDescriptor Create()
    {
        return new CommandDescriptor
        {
            ...
            Summary = "bitFlyer protocol private balance",
            ...
            CanonicalJsonExample = "exchangeapi bitflyer protocol private get-balance --query-json '{}'",
            CommandOptions = [],
            UsageExamples =
            [
                "exchangeapi bitflyer protocol private get-balance --query-json '{}'",
                "exchangeapi bitflyer protocol private get-balance --query-template",
            ],
            IsWrite = false,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var call = await bundle.Private.GetBalanceCallAsync(cancellationToken);
