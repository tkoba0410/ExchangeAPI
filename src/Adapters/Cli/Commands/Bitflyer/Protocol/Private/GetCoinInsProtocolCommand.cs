...
public static class GetCoinInsProtocolCommand
{
    private static readonly CommandPath Path = new("bitflyer", "protocol", "private", "get-coin-ins");
    ...
    public static CommandDescriptor Create()
    {
        return new CommandDescriptor
        {
            ...
            UsageExamples =
            [
                """exchangeapi bitflyer protocol private get-coin-ins --query-json '{"count":10}'""",
                "exchangeapi bitflyer protocol private get-coin-ins --query-template",
            ],
            IsWrite = false,
