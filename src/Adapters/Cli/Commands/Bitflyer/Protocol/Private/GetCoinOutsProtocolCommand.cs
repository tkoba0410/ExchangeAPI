...
public static class GetCoinOutsProtocolCommand
{
    private static readonly CommandPath Path = new("bitflyer", "protocol", "private", "get-coin-outs");
    ...
    public static CommandDescriptor Create()
    {
        return new CommandDescriptor
        {
            ...
            Summary = "bitFlyer protocol private coin outs",
            ...
            CanonicalJsonExample = """exchangeapi bitflyer protocol private get-coin-outs --query-json '{"count":10}'""",
            CommandOptions = [],
            UsageExamples =
            [
                """exchangeapi bitflyer protocol private get-coin-outs --query-json '{"count":10}'""",
                "exchangeapi bitflyer protocol private get-coin-outs --query-template",
            ],
            IsWrite = false,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var call = await bundle.Private.GetCoinOutsCallAsync(
            typed.GetInt("count"),
