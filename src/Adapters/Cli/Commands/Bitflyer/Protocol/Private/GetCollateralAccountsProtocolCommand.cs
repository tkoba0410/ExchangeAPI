...
public static class GetCollateralAccountsProtocolCommand
{
    private static readonly CommandPath Path = new("bitflyer", "protocol", "private", "get-collateral-accounts");
    ...
    public static CommandDescriptor Create()
    {
        return new CommandDescriptor
        {
            ...
            Summary = "bitFlyer protocol private collateral accounts",
            ...
            CanonicalJsonExample = "exchangeapi bitflyer protocol private get-collateral-accounts --query-json '{}'",
            CommandOptions = [],
            UsageExamples =
            [
                "exchangeapi bitflyer protocol private get-collateral-accounts --query-json '{}'",
                "exchangeapi bitflyer protocol private get-collateral-accounts --query-template",
            ],
            IsWrite = false,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var call = await bundle.Private.GetCollateralAccountsCallAsync(cancellationToken);
