...
public static class GetTradingCommissionProtocolCommand
{
    private static readonly CommandPath Path = new("bitflyer", "protocol", "private", "get-trading-commission");
    ...
    public static CommandDescriptor Create()
    {
        return new CommandDescriptor
        {
            ...
            UsageExamples =
            [
                """exchangeapi bitflyer protocol private get-trading-commission --query-json '{"product_code":"BTC_JPY"}'""",
                "exchangeapi bitflyer protocol private get-trading-commission --query-template",
            ],
            IsWrite = false,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var call = await bundle.Private.GetTradingCommissionCallAsync(
