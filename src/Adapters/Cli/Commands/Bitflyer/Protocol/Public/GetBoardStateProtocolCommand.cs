...
public static class GetBoardStateProtocolCommand
{
    private static readonly CommandPath Path = new("bitflyer", "protocol", "public", "get-board-state");
    ...
    public static CommandDescriptor Create()
    {
        return new CommandDescriptor
        {
            ...
            Summary = "bitFlyer protocol public board state",
            AuthenticationRequirement = "none",
            InputContract = CommandInputContract.ProtocolQuery(QuerySchema),
            CanonicalJsonExample = """exchangeapi bitflyer protocol public get-board-state --query-json '{"product_code":"BTC_JPY"}'""",
            CommandOptions = [],
            UsageExamples =
            [
                """exchangeapi bitflyer protocol public get-board-state --query-json '{"product_code":"BTC_JPY"}'""",
                "exchangeapi bitflyer protocol public get-board-state --query-template",
            ],
            IsWrite = false,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var call = await bundle.Public.GetBoardStateCallAsync(
