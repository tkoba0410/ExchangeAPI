...
{
    Task<CallResult<GetPermissionsRequest, IReadOnlyList<string>>> CallAsync(
...
public sealed class GetPermissionsNativeEndpoint : IGetPermissionsNativeEndpoint
{
    ...
    public Task<CallResult<GetPermissionsRequest, IReadOnlyList<string>>> CallAsync(
        GetPermissionsRequest request,
        CancellationToken cancellationToken = default)
    {
    ...
    private async Task<CallResult<GetPermissionsRequest, IReadOnlyList<string>>> CallAsyncCore(
        GetPermissionsRequest request,
        IApiCredentialSession? credentialSession,
