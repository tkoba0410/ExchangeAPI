...
namespace ExchangeApi.Exchanges.Bitflyer.Protocol.Private.Endpoints.GetCoinIns;

public interface IGetCoinInsProtocolEndpoint
{
...
public sealed class GetCoinInsProtocolEndpoint : IGetCoinInsProtocolEndpoint
{
    private const string Path = "/v1/me/getcoinins";
    private readonly IProtocolTransport _transport;

    public GetCoinInsProtocolEndpoint(IProtocolTransport transport)
    {
