...
namespace ExchangeApi.Exchanges.Bitflyer.Protocol.Private.Endpoints.GetCollateral;

public interface IGetCollateralProtocolEndpoint
{
...
public sealed class GetCollateralProtocolEndpoint : IGetCollateralProtocolEndpoint
{
    private const string Path = "/v1/me/getcollateral";
    private readonly IProtocolTransport _transport;

    public GetCollateralProtocolEndpoint(IProtocolTransport transport)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            EndpointId = BitflyerEndpointIds.GetCollateral,
