...
namespace ExchangeApi.Exchanges.Bitflyer.Protocol.Private.Endpoints.GetDeposits;

public interface IGetDepositsProtocolEndpoint
{
...
public sealed class GetDepositsProtocolEndpoint : IGetDepositsProtocolEndpoint
{
    private const string Path = "/v1/me/getdeposits";
    private readonly IProtocolTransport _transport;

    public GetDepositsProtocolEndpoint(IProtocolTransport transport)
    {
