...
namespace ExchangeApi.Exchanges.Bitflyer.Protocol.Private.Endpoints.Withdraw;

public interface IWithdrawProtocolEndpoint
{
...
public sealed class WithdrawProtocolEndpoint : IWithdrawProtocolEndpoint
{
    private const string Path = "/v1/me/withdraw";
    private readonly IProtocolTransport _transport;

    public WithdrawProtocolEndpoint(IProtocolTransport transport)
    {
