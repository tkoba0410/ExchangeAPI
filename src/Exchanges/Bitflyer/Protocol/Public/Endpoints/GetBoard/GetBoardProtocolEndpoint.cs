...
namespace ExchangeApi.Exchanges.Bitflyer.Protocol.Public.Endpoints.GetBoard;
...
public sealed class GetBoardProtocolEndpoint : IGetBoardProtocolEndpoint
{
    private const string Path = "/v1/getboard";
    private readonly IProtocolTransport _transport;

    public GetBoardProtocolEndpoint(IProtocolTransport transport)
    {
