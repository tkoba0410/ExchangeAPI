...
internal sealed class BittradeClientComponents
{
    ...
    public static BittradeClientComponents FromRestClient(IRestClient restClient, AccountId? accountId = null)
    {
        ...
        if (!hasAccountId)
        {
            ...
            return new BittradeClientComponents(publicApi, privateApi: null, markets);
        }
        ...
        return new BittradeClientComponents(normalizedComponents.Public, normalizedComponents.Private, marketsFull);
    }
}
