...
using ContractOrderBook = global::ExchangeApi.Contracts.Common.Dtos.BoardResponse;
...
public static class OrderBookExtensions
{
    ...
    private static FillEstimate Fill(IReadOnlyList<BoardLevel> levels, Size takerSize, bool isBuy, Size? targetSize, Price? targetPrice)
    {
