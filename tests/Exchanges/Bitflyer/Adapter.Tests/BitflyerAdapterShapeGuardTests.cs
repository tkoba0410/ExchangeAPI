...
public sealed class BitflyerAdapterShapeGuardTests
{
    [Fact]
    public void AdapterApi_DoesNotContainOperationLiterals()
    {
        var root = FindRepoRoot();
        var adapterPath = Path.Combine(root, "src", "Exchanges", "Bitflyer", "Adapter");
        ...
        foreach (var file in files)
        {
            ...
            Assert.DoesNotContain("\"Bitflyer.", text, StringComparison.Ordinal);
        }
    }
